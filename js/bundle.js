...
},{"jquery":2,"pagination-master/js/paginate":3}],2:[function(require,module,exports){
/*!
...
var numPages = ($('#story').children().length);
  ...
  paginate.scrollTo = function() {
    $('html, body').scrollTop($('#narrative').offset().top);
  };
